% <CustomTools>
%   <Menu>
%     <Item name="QuadColocSpotsWithTransformCoordinates" icon="Matlab" tooltip="Quaduple coloc analysis">
%       <Command>MatlabXT::XTQuadColocSpotsWithTransformCoordinates(%i)</Command>
%     </Item>
%     
%   </Menu>
%      <SurpassTab>
%        <SurpassComponent name="bpSpots">
%          <Item name="QuadColocTransformCoords" icon="Matlab" tooltip="Quadruple coloc analysis">
%            <Command>MatlabXT::XTQuadColocSpotsWithTransformCoordinates(%i)</Command>
%          </Item>
%        </SurpassComponent>
%      </SurpassTab>
...
function XTQuadColocSpotsWithTransformCoordinates( aImarisApplicationID )
% This is an Imaris extention file
